...
public class Class01_CrewAndPassengers {
    public static void main(String[] args) {

        // ternary

        int number = 50;
        String result1 = (number == 50 || number == 75 || number == 100)? // precondition, if failed then "Invalid will print, if true then it will check the 3 conditions below
                         (number == 50)? "20 crew, 30 passengers"
                        :(number == 75)? "25 crew, 50 passengers"
                        :"30 crew, 70 passengers"

                : "Invalid";
        // the multibranch if statement is easier to read, but the ternary is faster
...
determine how many need to be crew members and how many can be
