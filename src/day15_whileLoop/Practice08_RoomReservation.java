...
public class Practice08_RoomReservation {
}
/*
...
than yes/no) ask user to reenter until user provides a valid entry)
                    ...
                    Queen Bed ==> 100$
                    single Bed ==> 80$
Divisible By 3: 3 6 9 12 18 21 24 27 33
the program should be able to display the room he/she
reserved and total price of the room.
